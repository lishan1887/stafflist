<template>
  <div>
    ...
    <div class="mt">
      ...
      >
        <el-table-column prop="name" label="离职日期" width="120"></el-table-column>
        ...
        <el-table-column prop="rate" label="离职原因" width="120"></el-table-column>
        ...
        <el-table-column prop="date" label="岗位序列"  width="120"></el-table-column>
        <el-table-column prop="date" label="入职时间" width="120"></el-table-column>
        <el-table-column prop="date" label="入职途径" width="120"></el-table-column>
